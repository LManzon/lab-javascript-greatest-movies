...
function getAllDirectors(movies) {
  /*let directors = movies.map(director => ({value: movies.director}));
    return directors;*/
...
//    return 0;
//  }
//  const dramaAvg = movie.reduce(function (acc, value) {
//    if (!value.genre.includes("Drama")) {
//      return acc;
//    }
//    return acc + value.rate;
//  }, 0);
//  let dramaRateAvg = dramaAvg / movie.genre.includes("Drama").length;
//  return Math.round(dramaRateAvg * 100) / 100;
// }
